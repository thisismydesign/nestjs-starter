...
["DateTime"]:unknown;
	...
	["Mutation"]: AliasType<{
createOrder?: [{	thingName: string | Variable<any, string>,	alias: string | Variable<any, string>},ValueTypes["Order"]],
		__typename?: boolean | `@${string}`
}>
  }
...
["DateTime"]:unknown;
	...
	thing?:ResolverInputTypes["Thing"],
	created_at?:boolean | `@${string}`,
	updated_at?:boolean | `@${string}`,
		__typename?: boolean | `@${string}`
}>;
	...
	whoAmI?:ResolverInputTypes["User"],
	things?:ResolverInputTypes["Thing"],
	orders?:ResolverInputTypes["Order"],
		__typename?: boolean | `@${string}`
}>;
	["Mutation"]: AliasType<{
createOrder?: [{	thingName: string,	alias: string},ResolverInputTypes["Order"]],
		__typename?: boolean | `@${string}`
}>;
	["schema"]: AliasType<{
...
export type ModelTypes = {
	...
	username: string,
	name: string,
	orders: Array<ModelTypes["Order"] | undefined>,
...
export type GraphQLTypes = {
	...
	username: string,
	name: string,
	orders: Array<GraphQLTypes["Order"] | undefined>,
